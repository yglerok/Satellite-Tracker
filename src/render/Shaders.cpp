...
void Shader::setVec4(GLuint shader, const std::string& name, const glm::vec4& vector)
{
    glUniform4fv(glGetUniformLocation(shader, name.c_str()), 1, glm::value_ptr(vector));
}
