...
- Сохраняет в локальную базу SQLite3

- Вычисляет положение каждого аппарата с помощью модели SGP4

- Визуализирует орбитальное движение в реальном времени с помощью OpenGL

## :video_game: Управление

- **Колесо мыши** - zoom
- **ПКМ + перемещение** - вращение камеры
- **F11** - полноэкранный режим
- **R** - сброс положения камеры
